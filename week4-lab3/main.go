...
func main() {
	// var st Student = Student{ID:"1",Name:"",Email:"Khrueapan_c@su.ac.th",Year:4,GPA:3.75}

	// st := Student{ID:"1",Name:"chairampha",Email:"Khrueapan_c@su.ac.th",Year:4,GPA:3.75}
	students := []Student{
		{ID: "1", Name: "chairampha", Email: "Khrueapan_c@su.ac.th", Year: 4, GPA: 3.75},
